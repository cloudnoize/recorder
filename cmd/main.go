...
func playBuf(psp pa.PaStreamParameters, player *play, sf pa.SampleFormat, desiredSR uint64, sec int) {
	pa.CbStream = player
	s, err := pa.OpenStream(nil, &psp, sf, desiredSR, 1024)
	if err != nil {
